        ...
        <div className="grid-background"></div>
         ...
         <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">{testimonial.map((testimonial,index)=>{
              return(
               <Card key={index}
         ...
         <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-6xl mx-auto">
              <Accordion type="single" collapsible className="w-full">{faqs.map((faq,index)=>{
         ...
         <section className="w-full ">
          <div className=" mx-auto py-24 gradient rounded-lg">
            ...
            Read to Accelerate Your Career?
            </h2>
